...
define('LANA_FB_CHAT_05', 'Šířka avataru v menu');
define('LANA_FB_CHAT_06', 'Výška avataru v menu');
define('LANA_FB_CHAT_07', 'Šířka avataru na stránce');
define('LANA_FB_CHAT_08', 'Výška avataru na stránce');
define('LANA_FB_CHAT_09', 'Chat použitá třída CSS');
define('LANA_FB_CHAT_10', 'Rychlost chetu (min)');
define('LANA_FB_CHAT_11', 'Rychlost chetu (max)');
define('LANA_FB_CHAT_12', ' sek');
define('LANA_FB_CHAT_13', 'Titulek okna chetu');
...
define('LANA_FB_CHAT_20', 'Avatar pro chat');
define('LANA_FB_CHAT_21', 'Vzhled');
define('LANA_FB_CHAT_22', 'Styl zobrazení datumu');
define('LANA_FB_CHAT_23', 'Vytvářet klikací odkazy');
define('LANA_FB_CHAT_24', 'Vytvořit připojitelná Audio/Video HTML');
define('LANA_FB_CHAT_25', 'Plovoucí on-line seznam');
define('LANA_FB_CHAT_26', 'Rychlost chetu (menu)');
define("LANA_FB_CHAT_27", "Krátký styl datumu");
define("LANA_FB_CHAT_28", "Dlouhý styl datumu");
define("LANA_FB_CHAT_29", "Datumový styl fóra");
define("LANA_FB_CHAT_30", "Relativní styl datumu");
