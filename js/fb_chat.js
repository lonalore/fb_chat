...
(function ($)
{
	...
	$.fn.fb_chat = function (options)
	{
		...
		var init = function ()
		{
			...
			fb_chat.tpl.chatBox = '<div class="cbh"><div class="cbt"><div class="tc">...</div>' + /*fb_chat.tpl.iconSetts +*/ fb_chat.tpl.iconClose + '<div class="settscnt"></div></div><br clear="all"/></div><div class="cbc"></div><div class="cbi"><textarea class="form-control cbta" maxlength="255"></textarea></div>';
		...
		var chat_heartbeat = function ()
		{
			...
			$.ajax({
				...
				success: function (data)
				{
					...
					{
						if(fb_chat.conf.heartbeatCount >= 10)
						{
